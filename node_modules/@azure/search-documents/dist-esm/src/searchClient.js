...
export class SearchClient {
    ...
    async searchDocuments(searchText, options = {}, nextPageParameters = {}) {
        const { searchFields, semanticFields, select, orderBy, includeTotalCount, vectors, answers, semanticErrorHandlingMode, debugMode } = options, restOptions = __rest(options, ["searchFields", "semanticFields", "select", "orderBy", "includeTotalCount", "vectors", "answers", "semanticErrorHandlingMode", "debugMode"]);
