...
exports.BotState = exports.CACHED_BOT_STATE_SKIP_PROPERTIES_HANDLER_KEY = void 0;
/**
 * @module botbuilder
 */
/**
...
exports.CACHED_BOT_STATE_SKIP_PROPERTIES_HANDLER_KEY = Symbol('cachedBotStateSkipPropertiesHandler');
/**
...
class BotState {
    ...
    constructor(storage, storageKey) {
        ...
        this.skippedProperties = new Map();
    }
    /**
    ...
    load(context, force = false) {
        ...
        if (!context.turnState.get(exports.CACHED_BOT_STATE_SKIP_PROPERTIES_HANDLER_KEY)) {
            context.turnState.set(exports.CACHED_BOT_STATE_SKIP_PROPERTIES_HANDLER_KEY, (key, properties) => this.skippedProperties.set(key, properties));
        }
    ...
    saveChanges(context, force = false) {
        ...
        const state = this.skipProperties(cached === null || cached === void 0 ? void 0 : cached.state);
        if (force || (cached && cached.hash !== (0, storage_1.calculateChangeHash)(state))) {
            return Promise.resolve(this.storageKey(context)).then((key) => {
                if (!cached) {
                    cached = { state: {}, hash: '' };
                }
                ...
                return this.storage.write(changes).then(() => {
                    ...
                    cached.hash = (0, storage_1.calculateChangeHash)(state);
    ...
    skipProperties(state) {
        ...
        const skipHandler = (key) => {
            ...
            if (this.skippedProperties.has(key)) {
                return (_a = this.skippedProperties.get(key)) !== null && _a !== void 0 ? _a : [key];
            }
        };
        const inner = ([key, value], skip = []) => {
            ...
            return Object.entries(value).reduce((acc, [k, v]) => {
                var _a;
                const skipResult = (_a = skipHandler(k)) !== null && _a !== void 0 ? _a : [];
